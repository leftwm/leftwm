    ...
    fn default() -> Self {
        ...
        let mut commands = vec![
            ...
            Keybind {
                ...
                modifier: Modifier::List(vec!["modkey".to_owned()]),
                key: "p".to_owned(),
            },
            ...
            Keybind {
                ...
                modifier: Modifier::List(vec!["modkey".to_owned(), "Shift".to_owned()]),
                key: "Return".to_owned(),
            },
            ...
            Keybind {
                ...
                modifier: Modifier::List(vec!["modkey".to_owned(), "Control".to_owned()]),
                key: "l".to_owned(),
            },
        ...
        Self {
            ...
            mousekey: Modifier::Single("Mod4".to_owned()), //win key
            keybind: commands,
