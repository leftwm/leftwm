...
atom_manager! {
    ...
    AtomCollectionCookie {
        ...
        NetWMWindowTypeDropdownMenu: b"_NET_WM_WINDOW_TYPE_DROPDOWN_MENU",
        NetWMWindowTypePopupMenu: b"_NET_WM_WINDOW_TYPE_POPUP_MENU",
        NetWMWindowTypeTooltip: b"_NET_WM_WINDOW_TYPE_TOOLTIP",
        NetWMWindowTypeNotification: b"_NET_WM_WINDOW_TYPE_NOTIFICATION",
        NetWMWindowTypeCombo: b"_NET_WM_WINDOW_TYPE_COMBO",
        NetWMWindowTypeDnd: b"_NET_WM_WINDOW_TYPE_DND",
...
impl AtomCollection {
    pub fn get_name(&self, atom: xproto::Atom) -> &'static str {
        match atom {
            ...
            x if x == self.NetWMWindowTypeDropdownMenu => "_NET_WM_WINDOW_TYPE_DROPDOWN_MENU",
            x if x == self.NetWMWindowTypePopupMenu => "_NET_WM_WINDOW_TYPE_POPUP_MENU",
            x if x == self.NetWMWindowTypeTooltip => "_NET_WM_WINDOW_TYPE_TOOLTIP",
            x if x == self.NetWMWindowTypeNotification => "_NET_WM_WINDOW_TYPE_NOTIFICATION",
            x if x == self.NetWMWindowTypeCombo => "_NET_WM_WINDOW_TYPE_COMBO",
            x if x == self.NetWMWindowTypeDnd => "_NET_WM_WINDOW_TYPE_DND",
