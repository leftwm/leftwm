...
pub struct XAtom {
    ...
    pub NetWMWindowTypeCombo: xlib::Atom,
    pub NetWMWindowTypeDnd: xlib::Atom,
...
impl XAtom {
    ...
    pub fn new(xlib: &xlib::Xlib, dpy: *mut xlib::Display) -> Self {
        Self {
            ...
            NetWMWindowTypeCombo: from(xlib, dpy, "_NET_WM_WINDOW_TYPE_COMBO"),
            NetWMWindowTypeDnd: from(xlib, dpy, "_NET_WM_WINDOW_TYPE_DND"),
